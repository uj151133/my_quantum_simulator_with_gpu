...
// // void OperationCache::updateLRU(long long cacheKey) {
...
// void OperationCache::insert(long long cacheKey, OperationResult result) {
//     // while (!cacheMutex.try_lock()) {
//     //     boost::this_fiber::yield();
//     // }
//     // unique_lock<shared_mutex> lock(cacheMutex, adopt_lock);
//     if (cache.size() >= 250000) {
//         // long long oldestKey = lruList.back();
//         // lruList.pop_back();
...
// OperationResult OperationCache::find(long long cacheKey) const {
