...
void randomRotate2(size_t numQubits, size_t numGates = 200) {
...
void randomRotate4(size_t numQubits, size_t numGates = 200) {
...
void randomCX(size_t numQubits = 3, size_t numGates = 200, bool reverse = false) {
    ...
    for (int i = 0; i < numGates; ++i) {
        ...
        if (!reverse) circuit.addCX(0, 1);
        else circuit.addCX(1, 0);
