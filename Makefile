...
ifeq ($(shell uname), Darwin)
	...
	if [ -f /etc/fedora-release ]; then \
		...
		sudo apt-get install -y make build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev libsqlite3-dev wget curl llvm libncursesw5-dev xz-utils tk-dev libxml2-dev libxmlsec1-dev libffi-dev liblzma-dev openjdk-21-jdk libxxhash-dev libtbb-dev; \
